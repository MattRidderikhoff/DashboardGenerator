...
class Tokenizer
{
    const LITERALS = [Node::NODE_START_TOKEN, Node::TITLE_TOKEN, Chart::X_AXIS_TOKEN, Chart::Y_AXIS_TOKEN,
        ...
        Chart::ONLY_USE_TOKEN, Chart::GREATER_THAN_KEY, Chart::LESS_THAN_KEY, Chart::GREATER_THAN_OR_EQUAL_KEY, Chart::LESS_THAN_OR_EQUAL_KEY,
        Chart::IN_KEY, Chart::NOT_IN_KEY];
